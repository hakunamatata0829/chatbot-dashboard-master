  ...
  */
  ...
  var Popup =
    ...
    (function(_React$PureComponent) {
      ...
      function Popup(props) {
        ...
        _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), 'onEscape', function(
          e
        ) {
        ...
        _defineProperty(
          ...
          'lockScroll',
          function() {
            if (_this.state.modal && _this.props.lockScroll)
        ...
        _defineProperty(
          ...
          'togglePopup',
          function() {
            if (_this.state.isOpen) _this.closePopup();
            else _this.openPopup();
          }
        );
...

              {
                if (selector === null)
                  throw new Error(
                    ''.concat(
                      keepTooltipInside,
                      " selector is not exist : keepTooltipInside must be a valid html selector 'class' or 'Id'  or a boolean value"
                    )
                  );
              }
        ...
        _defineProperty(
          ...
          function() {
            ...
            if (keepTooltipInside || Array.isArray(position))
              positions = _toConsumableArray(positions).concat(POSITION_TYPES);
            var cords = calculatePosition(
              trigger,
              content,
              positions,
              arrow,
            ...
            if (
              window.getComputedStyle(_this.TriggerEl, null).getPropertyValue('position') ==
                'static' ||
              window.getComputedStyle(_this.TriggerEl, null).getPropertyValue('position') == ''
            )
              _this.TriggerEl.style.position = 'relative';
          }
        );
        ...
        _defineProperty(
          ...
          function() {
            ...
            if (typeof trigger === 'function')
              return React.cloneElement(trigger(_this.state.isOpen), triggerProps);
        ...
        _defineProperty(
          ...
          function() {
            ...
            return React.createElement(
              'div',
              _extends({}, _this.addWarperAction(), {
                key: 'C',
              }),
              arrow &&
                !modal &&
              ...
              typeof _this.props.children === 'function'
                ? _this.props.children(_this.closePopup, _this.state.isOpen)
...

  {
    ...
    Popup.propTypes = {
      ...
      children: PropTypes.oneOfType([PropTypes.func, PropTypes.element, PropTypes.string])
        .isRequired,
